    ...
    return (
        <section className="px-6 py-16 md:py-24">
            <div className="mx-auto max-w-5xl text-center">
                <div className="relative overflow-hidden rounded-[3rem] bg-gradient-to-br from-rose-500 to-pink-600 p-12 text-white shadow-2xl md:p-20">
                    {/* Decorative blobs */}
                    ...
                    <div className="relative z-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
                        <a
                            href="#demo-form"
                            className="rounded-2xl bg-white px-8 py-4 font-bold text-rose-600 shadow-xl transition-all hover:scale-105 hover:shadow-2xl"
                        >
                            Schedule Demo Now
                        </a>
                        <a
                    ...
                    <p className="relative z-10 mt-8 text-sm text-rose-200">
                        Trusted by 500+ businesses worldwide · SOC 2 compliant
                    </p>
                </div>
            </div>
        </section>
