                ...
                <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                    ...
                    <div className="flex-1 space-y-8">
                        ...
                        <ul className="space-y-4">
                            {[
                                "Private knowledge base — data never trains public AI models",
                                "Strict confidence thresholds prevent hallucinated answers",
                                "Multi-language auto-detection across 50+ languages",
                                "Custom brand voice, persona, and widget styling",
                            ].map((feature, i) => (
                    ...
                    <div className="flex-1 w-full relative group">
                        <div className="aspect-square max-w-[500px] ml-auto relative flex items-center justify-center">
                            ...
                            <Image
                                ...
                                alt="BolChat AI agent configuration dashboard — widget builder and persona settings"
                                width={600}
                                height={600}
