            ...
            <Container>
                <div className="mb-12 grid gap-12 md:grid-cols-4 lg:gap-8">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <div className="mt-8 flex items-center gap-4 text-slate-400">
                            ...
                            {/* YouTube */}
                            <a href="https://www.youtube.com/@BolchatAI" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="flex h-10 w-10 items-center justify-center rounded-full bg-white shadow-sm transition-all hover:-translate-y-1 hover:text-rose-500 hover:shadow-md">
                                <svg viewBox="0 0 24 24" className="h-[18px] w-[18px]" fill="currentColor">
                ...
                <div className="flex flex-col items-center justify-between gap-6 border-t border-slate-200/60 pt-8 text-sm font-medium text-slate-400 md:flex-row md:pt-12">
                    ...
                    <div className="flex flex-wrap items-center justify-center gap-4">
                        ...
                        <a href="https://www.saashub.com/bolchat-tech?utm_source=badge&utm_campaign=badge&utm_content=bolchat-tech&badge_variant=color&badge_kind=approved" target="_blank" rel="noopener noreferrer" className="transition-transform hover:scale-105">
                            <img src="https://cdn-b.saashub.com/img/badges/approved-color.png?v=1" alt="BolChat.tech badge" className="h-[36px] max-w-[150px] w-auto" />
                        </a>
                    </div>
                </div>
            </Container>
