                ...
                <div className="mb-12 grid gap-12 md:grid-cols-4 lg:gap-8">
                    ...
                    <div className="md:col-span-2">
                        ...
                        <div className="mt-8 flex items-center gap-4 text-slate-400">
                            ...
                            <a href="#" className="flex h-10 w-10 items-center justify-center rounded-full bg-white shadow-sm transition-all hover:-translate-y-1 hover:text-rose-500 hover:shadow-md">
